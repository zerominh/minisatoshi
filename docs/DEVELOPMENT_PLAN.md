...
| Terminology Wallet/Vault? | **Phương án A — đã code:** container = **Workspace / Không gian**; spendable = **Wallet / Ví**; rename API/DB. Chi tiết: [`docs/workspace-wallet-rename.md`](./workspace-wallet-rename.md) |
