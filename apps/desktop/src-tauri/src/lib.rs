...
use commands::{
    ...
    list_spending_paths, list_vaults, list_wallets, lock_hot_keystore, new_receive_address,
    prepare_hw_registration, save_text_file, sign_psbt_hot, sign_psbt_software, sync_vault,
    unlock_hot_keystore,
};
use state::AppState;
use tauri::Manager;
