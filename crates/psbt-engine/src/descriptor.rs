...
pub(crate) fn definite_descriptor_at(
    ...
    chain
        ...
        .map_err(|e| PsbtError::Descriptor(descriptor_engine::DescriptorError::Compile(e.to_string())))
}
...
fn select_chain_descriptor(
    ...
    if descriptor.is_multipath() {
        ...
        Err(PsbtError::Address(address_engine::AddressError::UnsupportedMultipath {
            is_change: true,
        }))
    } else {
        Ok(descriptor.clone())
